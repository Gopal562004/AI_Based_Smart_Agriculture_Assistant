...
def main():
    ...
    st.set_page_config(
    page_title="AI-Based Smart Agriculture Assistant",  # This sets the title in the browser tab
    page_icon="path/to/favicon.ico",  # Path to your favicon file
    layout="centered",  # Use "centered" for a centered layout
)
    st.title("AI-Based Smart Agriculture Assistant")
    
    # Sidebar menu for navigation
    menu = ["Home", "Weather Forecasting", "Irrigation Management", "Soil Health Analysis", "Crop Recommendation", "Crop Health Monitoring"]
